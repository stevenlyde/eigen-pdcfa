...
coob_matrix<IndexType,MemorySpace>
...
template <typename IndexType, class MemorySpace>
    ...
    ::sort_by_row(void)
    {
        cusp::detail::sort_by_row(row_indices, column_indices);
    }
...
template <typename IndexType, class MemorySpace>
    ...
    {
        cusp::detail::sort_by_row_and_column(row_indices, column_indices);
    }
...
// sort matrix elements by row index
template <typename Array1, typename Array2, typename IndexType, typename MemorySpace>
    void
